...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		...
		\draw[fill][red](1.91,-3.56) circle [radius=0.05];
		\draw(1.91,-3.56) circle [radius=0.05];
		\node at (2.11,-3.76) {$A_2$};
		
		
		\draw[fill][red](-5,-2.42) circle [radius=0.05];
		\draw(-5,-2.42) circle [radius=0.05];
		\node at (-5.3,-2.52) {$P$};
		
		
		\draw[fill][red](-1.5,-0.26) circle [radius=0.05];
		\draw(-1.5,-0.26) circle [radius=0.05];
		\node at (-1.7,-0.16) {$Q$};
		
		
		\draw[fill][red](4.59,-0.28) circle [radius=0.05];
		\draw(4.59,-0.28) circle [radius=0.05];
		\node at (4.89,-0.28) {$R$};
		
		
		\draw[fill][red](1.93,3.02) circle [radius=0.05];
		\draw(1.93,3.02) circle [radius=0.05];
		\node at (2.2,3.0) {$A_1$};
		
		\draw[thick][blue](-5,-2.42)--(-1.5,-0.26);
		\draw[thick][blue](-1.5,-0.26)--(4.59,-0.28);
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}[scale=0.6]
		...
		\draw[fill][red](2.91,0.21) circle [radius=0.05];
		\draw(2.91,0.21) circle [radius=0.05];
		\draw[fill][red](-0.56,5.32) circle [radius=0.05];
		\draw(-0.56,5.32) circle [radius=0.05];
		\draw[fill][red](-7.49,4.44) circle [radius=0.05];
		\draw(-7.49,4.44)circle [radius=0.05];
		\draw[fill][red](-9.02,-0.79) circle [radius=0.05];
		\draw(-9.02,-0.79) circle [radius=0.05];
		\draw[fill][red](-7.12,-4.58) circle [radius=0.05];
		\draw(-7.12,-4.58)  circle [radius=0.05];
		\draw[fill][red](0.45,-5.64) circle [radius=0.05];
		\draw(0.45,-5.64) circle [radius=0.05];
		\draw[fill][red](-2.73,0.45) circle [radius=0.05];
		\draw(-2.73,0.45) circle [radius=0.05];
		\draw[fill][red](-2.76,-0.20) circle [radius=0.05];
		\draw(-2.76,-0.20) circle [radius=0.05];
		\draw[fill][red](-2.67,1.52) circle [radius=0.05];
		\draw(-2.67,1.52) circle [radius=0.05];
		
		\draw[thick][blue](2.91,0.21)--(-0.56,5.32)--(-7.49,4.44)--(-9.02,-0.79)--(-7.12,-4.58)--(0.45,-5.64)--cycle ;
		...
		\draw[dashed,thick][blue](-2.34,7.46)--(-3.18,-7.94);
		\draw[dashed,thick][blue](-10.45,0.87)--(5.08,0.02);
...
\begin{center}
	\begin{tikzpicture}[scale=0.6]
		...
		\draw[thick][blue](0.66,-0.24)--(-2.96,3.84)--(-9.68,4.29)
		--(-11.35,-0.74)--(-7.59,-5.29)--(0.32,-3.49)--cycle ;
		
		
		\draw[fill][red](0.6,-0.77) circle [radius=0.05];
		\draw(0.6,-0.77) circle [radius=0.05];
		\draw[fill][red](0.5,-1.75) circle [radius=0.05];
		\draw(0.5,-1.75) circle [radius=0.05];
		\draw[fill][red](-4.6,0.21) circle [radius=0.05];
		\draw(-4.6,0.21) circle [radius=0.05];
		\draw[fill][red](-10.31,2.4) circle [radius=0.05];
		\draw(-10.31,2.4) circle [radius=0.05];
		\draw[fill][red](-10.66,1.36) circle [radius=0.05];
		...
		\draw[dashed,thick][blue](0.5,-1.75)--(-10.31,2.4);
		\draw[dashed,thick][blue](0.6,-0.77)--(-10.66,1.36);
