...
\begin{proof}
	...
	of $T$ must be another origin point, called $A_2$. By lemma 4 and 
	lemma 5 we know that $\iT_{A_2}$ is also a quadrilateral. If $\iT_{A_1}$ 
...
a little distance from $A$, because calculating of areas is a 
bit complicated. We use different colors to sign different domain 
for convenience. We clarify our notation. Let $\T$ be any function such that 
$\lim_{\epsilon \to 0}\frac{\T(\epsilon)}{\epsilon} = 1$, and
...
\begin{center}
	...
	\node at (-16.71,4.17){$M$};
	\draw[fill][lightgray](-15.28,4.26) circle [radius=0.04];
	\draw(-15.28,4.26) circle [radius=0.04];	
	\node at (-15.58,4.66){$Q$};
	...
	\node at (-15,5.6){$I$};
	\draw[fill][lightgray](-15.19,4.29) circle [radius=0.04];
	\draw(-15.19,4.29) circle [radius=0.04];
	\node at (-14.5,4.29){$U$};
	...
	\node at (-16.5,2.5){black};
	\end{tikzpicture}
\end{center}

Here is a local picture of points around $U$.
\begin{center}
	\begin{tikzpicture}[scale=0.75]
	\draw[fill][lightgray](-15.71,4.17) circle [radius=0.03];
	\draw(-15.71,4.17) circle [radius=0.03];
	\node at (-16.21,4.17){$M$};
	\draw[fill][lightgray](-15.38,4.24) circle [radius=0.03];
	\draw(-15.38,4.24) circle [radius=0.03];	
	\node at (-15.48,4.56){$Q$};
	\draw[fill][lightgray](-13.97,6.55) circle [radius=0.03];
	\draw(-13.97,6.55) circle [radius=0.03];
	\node at (-14.57,6.75){$G$};
	\draw[fill][lightgray](-14.76,5.08) circle [radius=0.03];
	\draw(-14.76,5.08) circle [radius=0.03];
	\node at (-15,5.6){$I$};
	\draw[fill][lightgray](-15.19,4.29) circle [radius=0.03];
	\draw(-15.19,4.29) circle [radius=0.03];
	\node at (-14.6,4.29){$U$};
	\draw[fill][lightgray](-14.29,2.26) circle [radius=0.03];
	\draw(-14.29,2.26) circle [radius=0.03];
	\node at (-13.69,2.3){$S$};
	
	\draw[black](-13.97,6.55)--(-15.19,4.29);
	\draw[black](-15.19,4.29)--(-15.71,4.17);
	\draw[black](-15.19,4.29)--(-14.29,2.26);
	\end{tikzpicture}
\end{center}
\begin{proof}
...
\begin{proof}
	...
	\angle CTA_2 = \angle CTA_1$. 
	We can get that $\angle BTA_3 = \angle TBA_3=\frac{\pi}{3}$ then we can get that $\iT_{A_3}$ 
...
\begin{center}
	...
	\node at (-5,12.22){$A_1$:(0.500,0.866)};
	\node at (-5,11.52){$B$:(0.404,2.121)};
	\node at (-5,10.82){$S_{hexagon}$=2.598};
	\node at (-5,10.02){$S_{OPQR}$=1.309};
	\node at (-5,9.12){$\frac{S_{OPQR}}{S_{hexagon}}$=0.504};
	\end{tikzpicture}	
\end{center}
...
this question. However, it is a pity that we have not solved the problem completely, 
